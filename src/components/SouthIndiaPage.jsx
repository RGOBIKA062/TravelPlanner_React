...
export default function SouthIndiaPage() {
  ...
  const tourData = [
    { title: 'KERALA TOUR', image: '/kerala.jpeg', price: 9000 },
    { title: 'TAMIL NADU TOUR', image: '/tamilnadu.jpeg', price: 8500 },
    { title: 'KARNATAKA TOUR', image: '/karnataka.jpeg', price: 9500 },
    { title: 'ANDHRA PRADESH TOUR', image: '/andhra.jpeg', price: 8000 }
  ];
  ...
  return (
    <div className="pt-5">
      <div
        style={{
          backgroundImage: `url('/southindia.png')`,
