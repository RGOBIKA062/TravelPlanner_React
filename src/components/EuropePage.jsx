...
export default function EuropePage() {
  ...
  const tourData = [
    { title: 'FRANCE TOURS', image: '/france.jpg', price: 15000 },
    { title: 'ITALY TOURS', image: '/italy.jpeg', price: 16000 },
    { title: 'GERMANY TOURS', image: '/germany.jpeg', price: 14000 },
    { title: 'LUXURY EUROPE TOURS', image: '/luxuray.jpeg', price: 25000 }
  ];
  ...
  return (
    <div className="pt-5">
      <div
        style={{
          backgroundImage: `url('/europetour.png')`,
